...
//
// Самостоятельной регистрации на сайте нет, поэтому первый администратор
// заводится только так — это единственный вход в систему прав. Дальше учётные
// записи создаются через админ-панель.
